...
function FoundItemCard({ item }) {
  ...
  return (
    <div className="mb-2 flex items-center justify-between rounded-2xl border border-[#E8DCCA] bg-white p-4 shadow-sm">
      
      {/* Left */}
      <div className="flex items-center gap-6">

        {/* Image */}
        <div className="h-28 w-28 overflow-hidden rounded-2xl bg-[#F7F4EE]">
          {item.image ? (
            <img
              src={item.image}
              alt={item.title}
